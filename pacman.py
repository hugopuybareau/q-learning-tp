...
class GameState:
    ...
    def getPacmanPosition(self):
        """
                Returns pacman position as x,y
                """
    ...
    def getGridSize(self):
        return self.data.food.width,self.data.food.height

    def getGrid(self):
        """
         return a 2D map of string
        """
        return self.data.getGrid()
